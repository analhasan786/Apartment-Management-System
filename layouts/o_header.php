...
<body>
    <header>
        ...
        <div class="sidebar_menu">
            <div class="logo">
                <a href="o_dashboard.php">Owner Dashboard</a>
            </div>
            ...
            <div class="menu">
                <ul>
                    ...
                    <li>
                        <a href="apartments.php">Manage Unit</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="payments.php">Manage Empoyees</a>
                    </li>
                    <li>
                        <a href="maintenance.php">Manage Rent</a>
                    </li>
                    
                    <li id="logout">
                        <a href="o_logout.php" class="btn">Logout</a>
                    </li>
