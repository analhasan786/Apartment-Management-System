...
$sql_apartment = "SELECT * FROM apartment_booking WHERE id = '$id' ";
...
<div class="container">
    ...
    <table>
        <tr>
            ...
            <td><?php echo isset($apartment['Apartment_No']) ? $apartment['Apartment_No'] : 'Not Available'; ?></td>
        </tr>
        <tr>
            <th>Rent Amount</th>
            <td><?php echo isset($apartment['Rent_Amount']) ? $apartment['Rent_Amount'] : 'Not Available'; ?></td>
        </tr>
    </table>
